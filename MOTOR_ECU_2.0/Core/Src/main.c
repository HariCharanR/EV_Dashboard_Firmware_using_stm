...
//	  sprintf(user_msg , "RPM:%d\nTEMP:%d\n" , (uint16_t)rpm , (uint8_t)(Temp[0]));
//	  HAL_UART_Transmit_DMA(&huart2, (uint8_t *)user_msg, strlen(user_msg));
